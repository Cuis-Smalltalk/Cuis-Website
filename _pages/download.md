...
```
cogspur/squeak Cuis-Smalltalk-Dev/Cuis5.0-4963.image
```
...
### Starting Cuis Smalltalk ###
* drop the Cuis5.0-4963.image over the Squeak.app file
* If you get "Squeak is an app downloaded from the Internet. Are you sure you want to open it?", click on [Open]
* Alternatively, you might:
```
./Squeak.app/Contents/MacOS/Squeak Cuis-Smalltalk-Dev-master/Cuis5.0-4963.image
```
...
### Starting Cuis Smalltalk ###
```
cogspur/Squeak.exe Cuis-Smalltalk-Dev/Cuis5.0-4963.image
```
...
### Starting Cuis Smalltalk ###
```
cogspur/squeak Cuis-Smalltalk-Dev/Cuis5.0-4963-32.image
```
...
```
cogspur/squeak Cuis-Smalltalk-Dev/Cuis5.0-4963-32.image
stkspur/squeak Cuis-Smalltalk-Dev/Cuis5.0-4963-32.image
```
...
* If you can't find Cuis5.0-4963-32.image, then this document is outdated. Use the Cuis spur image with the latest update number available.
